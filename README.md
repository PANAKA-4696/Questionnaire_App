...
## FB
実務で働いているAndroidエンジニアからFBをもらいました。
FBを項目化して、修正していこうと思っております。
- **READMEの作成** :ReadMEをしっかり作らないと説明書だけでは作成過程などをしっかり見てもらえない可能性がある。
  ☑ReadMEの作成
- **ファイル構造の見やすさ** :ファイル構造が画面ごとにまとまっていないため、この作品を見た人が理解しずらい、見るときに見づらいなどの可能性がある
  □ファイル構造の整理
- **技術力不足** :授業で習ったやり方でこのアプリ開発を行っていたが、授業で習った内容が古い内容であり、現在の主流となっているUI手法として、Jetpack Composeが主流であるため、今風に変える必要がある。
  □このアプリをJetpack Composeに対応させる。(先に親に提供するため親が使用し始めて安定してきたタイミングで変更しようと考えています。)
  □技術を学ぶための簡単なアプリの作成(ToDoアプリなど)
